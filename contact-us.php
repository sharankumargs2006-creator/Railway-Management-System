<?php 
    ...
    if(isset($_SESSION["uname"])){
        $uname = $_SESSION["uname"];
            ...
            include("header.php"); //otherwise add header.php
    }
...
<div id="contact" class="container bg-img">
  <h2 class="text-center">CONTACT & FEEDBACK</h2> <span id="error" class="text-danger text-bold offset-8"></span>
  <div class="row bg-grey pt-3">
    <div class="col-sm-5">
      <p>Contact us and we'll get back to you within 24 hours.</p>
      <p><span class="fa fa-map-marker"></span> Gadag,Karnataka, India</p>
      <p><span class="fa fa-phone"></span> +91 9999999999</p>
      <p><span class="fa fa-envelope"></span> contact_us@gmail.com</p>
    </div>
